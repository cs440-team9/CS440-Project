                                ...
                                <Form.Item label="Author" style={{ marginBottom: "0px" }}>
									{getFieldDecorator('authorID', {
										...
										<SuperSelect
											...
											filterOption={(input, option) => option.props.children.toLowerCase().indexOf(input.toLowerCase()) >= 0 || parseInt(option.props.value).toLowerCase().indexOf(input.toLowerCase()) >= 0}
										>
                                            {this.authorDropdown}
                                        </SuperSelect>
                                    )}
